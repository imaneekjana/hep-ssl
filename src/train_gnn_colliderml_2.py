...
parser.add_argument('--split', default='dihiggs', help='dataset type')
...
parser.add_argument('--off', default=10, type=int, help='loading weights from previously trained model')
...
augment = Compose([
    RandomRotateXY((-args.rotation, args.rotation)),
